...
document.addEventListener("DOMContentLoaded", () => {
  ...
  popupSave.addEventListener("click", (e) => {
    if (e.target === popupSave) popupSave.style.display = "none";
  });
  ...
  popupCancel.addEventListener("click", (e) => {
    if (e.target === popupCancel) popupCancel.style.display = "none";
  });

  popupCancelled.addEventListener("click", (e) => {
    if (e.target === popupCancelled) popupCancelled.style.display = "none";
  });
});
